...
export const metadata: Metadata = {
  ...
  description:
    "Публичная справка о Евгении Лашкове: инвестор, преподаватель МГИМО, финансы, инвестиции, образование, медиа, отзывы участников и открытые источники.",
  alternates: {
    canonical: "/",
  },
  keywords: [
    ...
    "Евгений Лашков отзывы",
    "отзывы о Евгении Лашкове",
    "Лашков Евгений Игоревич отзывы",
    "Клуб двух запятых отзывы",
  ...
  openGraph: {
    ...
    description:
      "Факты о Евгении Лашкове: инвестиции, МГИМО, публичная деятельность, публикации, выступления, текстовые отзывы, скриншоты отзывов и источники для самостоятельной проверки.",
    type: "profile",
    locale: "ru_RU",
    url: "/",
  ...
  twitter: {
    ...
    description:
      "Публичная справка: факты, источники, образовательная деятельность, медиа, отзывы участников и проверяемая информация о Евгении Лашкове.",
